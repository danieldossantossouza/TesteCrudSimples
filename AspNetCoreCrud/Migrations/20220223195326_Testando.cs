    ...
    public partial class Testando : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CadastroViagens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CadastroViagens_Motoristas_MotoristaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Eixo = table.Column<string>(maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    MotoristaId = table.Column<Guid>(nullable: false),
                    NomeRua = table.Column<string>(maxLength: 100, nullable: false),
